                ...
                <div className="col-md-6 d-flex justify-content-center align-items-center py-5">
                    <div className="cont-cadastro w-100" style={{ maxWidth: '420px' }}>
                        ...
                        <section className="cont-logo text-center mb-4">
                            ...
                            <h3 className="fw-bold mt-2" style={{ color: '#161C5C', fontFamily: 'serif' }}>Login Adm</h3>
                        </section>
                        ...
                        <form onSubmit={handleLogin}>
                            ...
                            <div className="d-grid gap-3 mt-4">
                                <button type="submit" className="btn btn-primario-elegante-adm w-100 py-2 fw-bold" disabled={loading}>
                                    {loading ? 'Entrando...' : 'Entrar'}
                                </button>
 
                                <div className="text-center mt-2">
                                    <span className="text-muted small">Não possui uma conta? </span>
                                    <Link to="/cadastroadm" className="text-decoration-none fw-bold" style={{ color: '#161C5C' }}>
                                        Cadastre-se aqui.
                                    </Link>
                                </div>
                                <div className="text-center mt-2">
                                    <span className="text-muted small">Deseja recuperar a senha? </span>
                                    <Link to="/recuperarsenhaadm" className="text-decoration-none fw-bold" style={{ color: '#161C5C' }}>
                                        Recuperar a senha
                                    </Link>
                                </div>
                            </div>
